...
>
> **Εκκρεμεί:** το οβάλ «Πάγια εντολή εξόφλησης μέσω τραπεζικού λογαριασμού»
> (`pliromi_pagia_entoli` ← `extra_json.payment_method`) εξακολουθεί να μην
> έχει συντεταγμένη σε κανένα έντυπο Protergia. Είναι εντολή χρέωσης
> τραπεζικού λογαριασμού, οπότε θέλει δικό της πέρασμα επαλήθευσης πριν
> τσεκαριστεί αυτόματα.
