...
function renderDocuments(view, d) {
	...
	view.innerHTML =
		...
		'<button type="button" class="ecrm-btn ecrm-btn--ghost ecrm-btn--sm" data-doc-reviewall">' +
		'<svg class="ecrm-i" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-3-6.7"/><path d="M21 3v6h-6"/></svg>' +
