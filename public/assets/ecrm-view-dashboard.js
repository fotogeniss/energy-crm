...
function why(it) {
	...
	// Ό,τι απομένει είναι presale: το DashboardRepository::NEEDS_ME δίνει
	// ακριβώς τρεις καταστάσεις, και οι δύο πιάστηκαν παραπάνω.
	return { act: 'Δικαιολογητικά', tip: 'Λείπουν δικαιολογητικά — ' + ago };
}
