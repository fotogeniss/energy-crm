...
class ECRM_Shortcodes {
	...
	private const MODULES = [
		...
		'@energy-crm/view-customer-card' => 'ecrm-view-customer-card.js',
		...
		'@energy-crm/view-training'    => 'ecrm-view-training.js',
		...
		// Ειχε ξεχαστει απο εδω στο (243) -- το ecrm-app.js το εισαγε, ο
		// browser δεν μπορουσε να λυσει το bare specifier χωρις καταχωρηση, και
		// πεταγε ΟΛΟΚΛΗΡΟ το ecrm-app.js: καθε οθονη εμενε στο «Φορτωση…».
		// Το φυλαει πλεον ο ModuleMapMatchesRealImportsTest.
		'@energy-crm/view-documents'   => 'ecrm-view-documents.js',
	...
	private const MODULE_DEPS = [
		...
		'@energy-crm/view-calc'        => [ '@energy-crm/util' ],
		'@energy-crm/view-customers'   => [ '@energy-crm/util', '@energy-crm/format', '@energy-crm/navigate' ],
		'@energy-crm/view-customer-card' => [
			'@energy-crm/util',
			'@energy-crm/format',
			'@energy-crm/navigate',
			'@energy-crm/dialog',
		...
		'@energy-crm/view-kb'          => [ '@energy-crm/util' ],
		'@energy-crm/view-training'    => [ '@energy-crm/util' ],
		'@energy-crm/view-network'     => [ '@energy-crm/util', '@energy-crm/format', '@energy-crm/navigate' ],
		...
		'@energy-crm/view-escalations' => [ '@energy-crm/util', '@energy-crm/navigate' ],
	...
	public static function enqueue_form_assets(): void {
		...
		self::print_config( [
			...
			// assets/forms/{πάροχος}/{template}-{n}.jpg -- ήδη δημόσια στατικά αρχεία,
		...
		<div class="ecrm-form" data-step="config" lang="el">
			...
			<section class="ecrm-card" data-when-energy="mobile">
				...
				<div class="ecrm-grid">
					 ...
					 * παρακάτω, όχι εδώ -- δεν ζητάμε το ίδιο πράγμα δύο φορές. (269):
					 * προστέθηκε το μονό κουτί της κορυφής σελ.6 (gdpr_rights_ack) --
					 * ίδια λογική, το 'no_directory_listing' λίγο πιο κάτω επίσης δεν
					 * επαναλαμβάνεται εδώ.
					 */
					...
					$ecrm_yesno( 'gdpr_rights_ack', 'Ενημερώθηκε για δικαίωμα ανάκλησης συναίνεσης & καταγγελίας (dpa.gr);' );
					?>
				</div>
			...
			<section class="ecrm-card">
				...
				<div class="ecrm-grid">
					...
					// (269): ίδια περίπτωση με το 'no_marketing_calls' παραπάνω -- το
					// orizon_mobile.json τυπώνει τη δήλωση καταλόγου στη σελ.6, οπότε
					// πλέον ΚΑΙ mobile.
					$ecrm_yesno( 'no_directory_listing', 'Να ΜΗΝ καταχωρηθεί στους τηλεφωνικούς καταλόγους;', 'power,gas,mobile' );
					?>
				</div>
