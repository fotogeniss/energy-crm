 ...
 * `?ecrm_intake=TOKEN` χωρίς λογαριασμό, γράφει ΕΝΑ πεδίο -- το κινητό του --
 * φωτογραφίζει λογαριασμό και ταυτότητα, δίνει συναίνεση. Το ονοματεπώνυμο
 * ΔΕΝ ζητιέται: είναι τυπωμένο πάνω στην ταυτότητα και το διαβάζει το AI.
 * Στον πωλητή εμφανίζεται Υποψήφιος με τα αρχεία ήδη μέσα.
 *
