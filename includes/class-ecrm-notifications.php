...
class ECRM_Notifications {
	 ...
	 *
	 * ΜΕΤΡΗΜΕΝΟ κενό, όχι εικασία (31/08/2026): έλειπε το στάδιο «στάλθηκε
	 ...
	 * και στο `followups_for()` ΚΑΙ στο `escalations()` (197), και μια τέτοια
	 * αίτηση μπορούσε να κάτσει επ' άπειρον χωρίς να το μάθει ούτε ο
	 * συνεργάτης ούτε ο προϊστάμενός του.
	 *
	 * Ίδιο κατώφλι μερών με τα υπόλοιπα -- ρωτήθηκε ρητά ο ιδιοκτήτης αν το
	 * στάδιο που περιμένει πάροχο (όχι συνεργάτη) χρειάζεται μεγαλύτερο
	...
	public static function notify_status_change( int $contract_id, string $to ): void {
		// 07/09/2026: το σήμα ήταν η κατάσταση `pending` -- «κάτι την
		// μπλοκάρει». Αυτή έγινε **εμπόδιο** σε δικό της πίνακα, οπότε το
