...
final class ProviderFormFieldsTest extends TestCase
{
    ...
    public static function impersonalInputs(): array
    {
        return [
            ...
            ['combo_energy_same'],
            // Σταδιο 4 (05/09/2026): το ιδιο ζευγος για την ΑΛΛΗ κατευθυνση
            // (COMBO απο αιτηση Volton). Ιδιος λογος, ιδια συνεπεια αν
            // κρυπτογραφηθουν: η αιτηση θα ζηταει μια υπογραφη αντι για δυο.
            ['combo_mobile_same'],
            ['combo_mobile_offer'],
            // Προϊοντικη επιλογη, οχι προσωπικο δεδομενο -- ιδιο με το
            // `mobile_offer` πιο πανω. Τυπωνεται ως κουτακι στο εντυπο.
            ['combo_mobile_plan'],
        ];
    }
