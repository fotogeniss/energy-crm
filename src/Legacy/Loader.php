...
final class Loader {
	...
	private static bool $files_loaded = false;
	...
	/**
	 * Legacy modules with a static `init()` that registers WordPress hooks.
	 *
	 * @return string[]
	 */
	...
	public static function load_files(): void {
		...
		$dir    = $plugin ? $plugin->dir() : trailingslashit( dirname( __DIR__, 2 ) );
