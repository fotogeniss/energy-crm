...
final class Services
{
    ...
    private static ?CustomerEventRepository $customerEvents = null;
    ...
    public static function customerEvents(): CustomerEventRepository
    {
        return self::$customerEvents ??= new CustomerEventRepository();
    }
