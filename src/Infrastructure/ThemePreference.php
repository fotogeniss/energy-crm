...
final class ThemePreference
{
    ...
    /**
     * Προεπιλογή το σκούρο, απόφαση ιδιοκτήτη 2026-08-25 (HANDOVER §6γ,
     * item 8 — πρόταση `docs/UI-DARK-DEFAULT.html`, 21/08, εγκρίθηκε
     * σήμερα). Ήταν ανοιχτό μέχρι τώρα σκόπιμα, ίδιος λόγος με πάντα:
     * όποιος δεν έχει διαλέξει βλέπει ό,τι θεωρείται σήμερα η κανονική
     * εμφάνιση της εφαρμογής — και αυτή είναι πια η σκούρη. Ο διακόπτης
     * δεν αλλάζει: όποιος προτιμά το ανοιχτό το διαλέγει και μένει εκεί.
     */
