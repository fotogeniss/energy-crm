 ...
 *
 * Ενα option, όλα τα hooks μαζί -- τέσσερις εγγραφές δεν χρειάζονται τέσσερα
 * options.
 *
 * @package EnergyCRM
 */
...
final class Heartbeat
{
    ...
    public static function mark(string $hook): void
    {
        ...
        // Το option απαντά «πότε έτρεξε τελευταία φορά». Ο μετρητής απαντά
        // «πόσες φορές έτρεξε τον τελευταίο μήνα» -- και μόνο ο δεύτερος
        // δείχνει εργασία που αστοχεί μία στις τρεις, με το option να δείχνει
        // πάντα χθεσινή ώρα και την Υγεία πράσινη.
        Metrics::bump(Metrics::cron($hook));
    }
